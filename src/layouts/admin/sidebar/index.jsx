...
export default function SidebarAdmin({
  ...
  return (
    <>
      <div
        className={!isClose ? "sidebar-overlay" : ""}
          ...
          <ul className="sidebar-list">
            ...
            <li className="sidebar-item hidden">
              <NavLink to="productDetail" className="sidebar-link">
                ...
                <span className="sidebar-link-name">
                  {t("admin.0.sidebar.0.productDetail")}
                </span>
              </NavLink>
            </li>
            <li className="sidebar-item">
          ...
          <ul className="sidebar-logout">
            ...
            <li className="sidebar-item sidebar-mode">
              <div className="sidebar-link">
                ...
                <span className="sidebar-link-name">
                  {isDarkMode
                    ? t("admin.0.sidebar.0.darkMode")
                    : t("admin.0.sidebar.0.lightMode")}
                </span>
              </div>
              <div className="sidebar-toggle">
                <span
                  className={`sidebar-switch ${isDarkMode ? "dark" : ""}`}
