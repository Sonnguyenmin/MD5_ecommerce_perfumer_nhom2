...
export default function ProductReview({ productId, handleCommentChange, handleSubmit, commentText }) {
  ...
  return (
    <>
      <div className="mt-14">
        ...
        {selectedValue === 'Reviews' && <ProductRelateReviews productId={productId} />}
      </div>
    </>
  );
}
